...
import com.anbang.qipai.admin.msg.channel.sink.resultsink.ChayuanShuangkouResultSink;
...
import com.anbang.qipai.admin.plan.bean.historicalresult.puke.ChayuanShuangkouJuPlayerResult;
import com.anbang.qipai.admin.plan.bean.historicalresult.puke.ChayuanShuangkouPanPlayerResult;
...
public class ChayuanShuangkouResultMsgReceiver {
	...
	public void recordMajiangHistoricalResult(CommonMO mo) {
		...
		if ("chayuanshuangkou ju result".equals(msg)) {
			...
			majiangHistoricalResult.setGame(Game.chayuanShuangkou);
