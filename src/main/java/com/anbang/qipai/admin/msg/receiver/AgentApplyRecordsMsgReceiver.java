...
import com.anbang.qipai.admin.msg.channel.AgentApplyRecordsSlink;
...
@EnableBinding(AgentApplyRecordsSlink.class)
public class AgentApplyRecordsMsgReceiver {
	...
	@StreamListener(AgentApplyRecordsSlink.AGENTAPPLYRECORDS)
