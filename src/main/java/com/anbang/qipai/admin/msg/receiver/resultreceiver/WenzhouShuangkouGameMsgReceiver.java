...
import com.anbang.qipai.admin.msg.channel.sink.resultsink.WenzhouShuangkouGameSink;
...
//			Map data = (Map) mo.getData();
//			String gameId = (String) data.get("gameId");
//			GameRoom gameRoom = gameService.findRoomByGameAndServerGameGameId(Game.wenzhouShuangkou, gameId);
...
//			}
//			gameService.gameRoomFinished(Game.wenzhouShuangkou, gameId);
		}
