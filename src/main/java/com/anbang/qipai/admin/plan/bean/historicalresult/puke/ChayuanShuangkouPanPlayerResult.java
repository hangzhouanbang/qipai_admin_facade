...
public class ChayuanShuangkouPanPlayerResult implements GamePanPlayerResult {
	private String playerId;// 玩家id
	private String nickname;// 玩家昵称
	private int score;// 一盘总分

	public ChayuanShuangkouPanPlayerResult() {

	}

	public ChayuanShuangkouPanPlayerResult(Map panPlayerResult) {
