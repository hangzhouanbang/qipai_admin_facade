...
public class WenzhouShuangkouPanPlayerResult implements GamePanPlayerResult {
	private String playerId;// 玩家id
	private String nickname;// 玩家昵称
	private int score;// 一盘总分

	public WenzhouShuangkouPanPlayerResult() {

	}

	public WenzhouShuangkouPanPlayerResult(Map panPlayerResult) {
